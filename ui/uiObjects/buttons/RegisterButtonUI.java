...
public class RegisterButtonUI extends UIObject{

    private TextFieldUI username, password;

    public RegisterButtonUI(int x, int y, TextFieldUI username, TextFieldUI password) {
        super("login button");
        // TODO Auto-generated constructor stub
        icon = SpriteType.REGISTER_BUTTON;
        tintedIcon = SpriteType.TINTED_REGISTER_BUTTON;
        currSprite = icon;
    ...
    public void onClick(Point p, Scene scene) {
        ...
        if(canBeClicked()) {
            ...
            if(Game.getInstance().register(username.getText(), password.getText())) {
